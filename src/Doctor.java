...
public class Doctor extends javax.swing.JFrame {
    ...
    void connect()
   {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SEARCH BY SPECIALIZATION");

        jLabel2.setForeground(new java.awt.Color(204, 0, 0));
        jLabel2.setText("*only caps");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(97, 97, 97)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(btnsearch, javax.swing.GroupLayout.DEFAULT_SIZE, 175, Short.MAX_VALUE)
    ...
    private void btnsearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsearchActionPerformed
      try
      {
         ...
         rs=st.executeQuery("select * from managedoctor where specialization='"+s+"'" );
         txttable.setModel(DbUtils.resultSetToTableModel(rs));
      }
      catch(SQLException sql)
      {
